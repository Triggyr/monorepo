...
import type { TriggyrWalletApiRequest, TriggyrWalletSwapTokensResponse, TriggyrWalletSwapTokens, TriggyrWalletSwapSearchResponse, TriggyrWalletSwapSearch, TriggyrWalletSwapQuoteResponse, TriggyrWalletSwapPayload, TriggyrWalletSwapExecuteResponse } from '../types';
export default class Swap {
    private http;
    constructor(http: Http);
    quote: (payload: TriggyrWalletApiRequest<TriggyrWalletSwapPayload>) => Promise<TriggyrWalletSwapQuoteResponse>;
    execute: (payload: TriggyrWalletApiRequest<TriggyrWalletSwapPayload>) => Promise<TriggyrWalletSwapExecuteResponse>;
